...
proto_options=[ 
      { "mkopts" => "CT_TARGET=granite_eng                 CT_RELEASE=cool_profile" },
      { "mkopts" => "CT_TARGET=granite_eng_norom           CT_RELEASE=cool_profile" },
...
# coolmmi
coolmmi_path="#{soft_workdir}/application/coolmmi/main"
coolmmi_options=[
...
flash_programmer_options=[
     { "mkopts" => "CT_TARGET=granite_eng           CT_RELEASE=release CT_RAMRUN=1" },
     ...
     { "mkopts" => "CT_TARGET=greenstone_cs2324c CT_RELEASE=release CT_RAMRUN=1 FASTPF_USE_USB=0" },
     ...
     { "mkopts" => "CT_TARGET=greenstone_cs2324c CT_RELEASE=release CT_RAMRUN=1 FASTPF_USE_USB=1" },
...
reftest_mps_options=[
     { "mkopts" => "CT_TARGET=granite_eng_norom     CT_RELEASE=cool_profile CSW_EXTENDED_API=1" },

...
#define HAVE_bitswapsi2 (ISA_HAS_BITSWAP)
#define HAVE_bitswapdi2 ((ISA_HAS_BITSWAP) && (TARGET_64BIT))
#define HAVE_closi2 (ISA_HAS_CLZ_CLO)
#define HAVE_clodi2 ((ISA_HAS_CLZ_CLO) && (TARGET_64BIT))
#define HAVE_clzsi2 (ISA_HAS_CLZ_CLO)
#define HAVE_clzdi2 ((ISA_HAS_CLZ_CLO) && (TARGET_64BIT))
#define HAVE_clzsi2_inv (ISA_HAS_CLZ_CLO)
#define HAVE_clzdi2_inv ((ISA_HAS_CLZ_CLO) && (TARGET_64BIT))
#define HAVE_ctzsi2 (ISA_HAS_CLZ_CLO && ISA_HAS_BITSWAP)
#define HAVE_ctzdi2 ((ISA_HAS_CLZ_CLO && ISA_HAS_BITSWAP) && (TARGET_64BIT))
#define HAVE_ctzsi2_inv (ISA_HAS_CLZ_CLO && ISA_HAS_BITSWAP)
#define HAVE_ctzdi2_inv ((ISA_HAS_CLZ_CLO && ISA_HAS_BITSWAP) && (TARGET_64BIT))
...
#define HAVE_storeqi_premod (HAVE_PRE_MODIFY_DISP)
#define HAVE_storehi_premod (HAVE_PRE_MODIFY_DISP)
#define HAVE_storesi_premod (HAVE_PRE_MODIFY_DISP)
...
#define HAVE_rotrdi3 ((((TARGET_64BIT) && (ISA_HAS_ROR)) && (TARGET_64BIT)) && (TARGET_64BIT))
...
#define HAVE_mips_lbux (ISA_HAS_LBUX)
#define HAVE_mips_lhx (ISA_HAS_LHX)
#define HAVE_mips_lwx (ISA_HAS_LWX)
#define HAVE_mips_ldx ((ISA_HAS_LDX) && (TARGET_64BIT))
...
extern rtx        gen_bitswapsi2                      (rtx, rtx);
extern rtx        gen_bitswapdi2                      (rtx, rtx);
extern rtx        gen_closi2                          (rtx, rtx);
extern rtx        gen_clodi2                          (rtx, rtx);
extern rtx        gen_clzsi2                          (rtx, rtx);
extern rtx        gen_clzdi2                          (rtx, rtx);
extern rtx        gen_clzsi2_inv                      (rtx, rtx);
extern rtx        gen_clzdi2_inv                      (rtx, rtx);
extern rtx        gen_ctzsi2                          (rtx, rtx);
extern rtx        gen_ctzdi2                          (rtx, rtx);
extern rtx        gen_ctzsi2_inv                      (rtx, rtx);
extern rtx        gen_ctzdi2_inv                      (rtx, rtx);
...
extern rtx        gen_storeqi_premod                  (rtx, rtx, rtx);
extern rtx        gen_storehi_premod                  (rtx, rtx, rtx);
extern rtx        gen_storesi_premod                  (rtx, rtx, rtx);

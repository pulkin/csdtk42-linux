...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_DISABLE_SAVE_RESTORE;
#else
  int x_TARGET_DISABLE_SAVE_RESTORE;
#define TARGET_DISABLE_SAVE_RESTORE global_options.x_TARGET_DISABLE_SAVE_RESTORE
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_XCPU_ENABLE_PREMOD_STORE;
#else
  int x_TARGET_XCPU_ENABLE_PREMOD_STORE;
#define TARGET_XCPU_ENABLE_PREMOD_STORE global_options.x_TARGET_XCPU_ENABLE_PREMOD_STORE
#endif
#ifdef GENERATOR_FILE
extern int TARGET_XCPU_ENABLE_REGREG_LOAD;
#else
  int x_TARGET_XCPU_ENABLE_REGREG_LOAD;
#define TARGET_XCPU_ENABLE_REGREG_LOAD global_options.x_TARGET_XCPU_ENABLE_REGREG_LOAD
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mdisable_save_restore = 1164,          /* -mdisable-save-restore */
  OPT_mdivide_breaks = 1165,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1166,                  /* -mdivide-traps */
  OPT_mdmx = 1167,                           /* -mdmx */
  OPT_mdouble_float = 1168,                  /* -mdouble-float */
  OPT_mdsp = 1169,                           /* -mdsp */
  OPT_mdspr2 = 1170,                         /* -mdspr2 */
  OPT_meb = 1171,                            /* -meb */
  OPT_mel = 1172,                            /* -mel */
  OPT_membedded_data = 1173,                 /* -membedded-data */
  OPT_menable_premodify_stores = 1174,       /* -menable-premodify-stores */
  OPT_menable_regreg_indexed_loads = 1175,   /* -menable-regreg-indexed-loads */
  OPT_meva = 1176,                           /* -meva */
  OPT_mexplicit_relocs = 1177,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1178,                  /* -mextern-sdata */
  OPT_mfix_24k = 1179,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1180,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1181,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1182,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1183,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1184,                       /* -mfix-sb1 */
  ...
  OPT_mmt = 1221,                            /* -mmt */
  OPT_mnan_ = 1222,                          /* -mnan= */
  OPT_mno_float = 1223,                      /* -mno-float */
  OPT_mno_flush_func = 1224,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1225,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1226,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1227,                     /* -mno-mips3d */
  OPT_modd_spreg = 1228,                     /* -modd-spreg */
  OPT_mpaired_single = 1229,                 /* -mpaired-single */
  OPT_mplt = 1230,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1231,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1232,               /* -mrelax-pic-calls */
  OPT_mshared = 1233,                        /* -mshared */
  OPT_msingle_float = 1234,                  /* -msingle-float */
  OPT_msmartmips = 1235,                     /* -msmartmips */
  OPT_msoft_float = 1236,                    /* -msoft-float */
  OPT_msplit_addresses = 1237,               /* -msplit-addresses */
  OPT_msym32 = 1238,                         /* -msym32 */
  OPT_msynci = 1239,                         /* -msynci */
  OPT_mtune_ = 1240,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1241,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1242,                          /* -mvirt */
  OPT_mvr4130_align = 1243,                  /* -mvr4130-align */
  OPT_mxgot = 1244,                          /* -mxgot */
  OPT_mxpa = 1245,                           /* -mxpa */
  OPT_n = 1246,                              /* -n */
  OPT_no_canonical_prefixes = 1247,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1248,              /* -no-integrated-cpp */
  OPT_no_pie = 1249,                         /* -no-pie */
  OPT_noasmopt = 1250,                       /* -noasmopt */
  ...
  /* OPT_std_c__03 = 1297, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1298, */                /* -std=c++0x */
  OPT_std_c__11 = 1299,                      /* -std=c++11 */
  OPT_std_c__14 = 1300,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1301, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1302, */                /* -std=c++1y */
  OPT_std_c__1z = 1303,                      /* -std=c++1z */
  OPT_std_c__98 = 1304,                      /* -std=c++98 */
  OPT_std_c11 = 1305,                        /* -std=c11 */
  /* OPT_std_c1x = 1306, */                  /* -std=c1x */
  /* OPT_std_c89 = 1307, */                  /* -std=c89 */
  OPT_std_c90 = 1308,                        /* -std=c90 */
  OPT_std_c99 = 1309,                        /* -std=c99 */
  /* OPT_std_c9x = 1310, */                  /* -std=c9x */
  OPT_std_f2003 = 1311,                      /* -std=f2003 */
  OPT_std_f2008 = 1312,                      /* -std=f2008 */
  OPT_std_f2008ts = 1313,                    /* -std=f2008ts */
  OPT_std_f95 = 1314,                        /* -std=f95 */
  OPT_std_gnu = 1315,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1316, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1317, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1318,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1319,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1320, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1321, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1322,                    /* -std=gnu++1z */
  ...
  OPT_std_legacy = 1335,                     /* -std=legacy */
  OPT_symbolic = 1336,                       /* -symbolic */
  OPT_t = 1337,                              /* -t */
  OPT_time = 1338,                           /* -time */
  OPT_time_ = 1339,                          /* -time= */
  OPT_traditional = 1340,                    /* -traditional */
  OPT_traditional_cpp = 1341,                /* -traditional-cpp */
  OPT_trigraphs = 1342,                      /* -trigraphs */
  OPT_u = 1343,                              /* -u */
  OPT_undef = 1344,                          /* -undef */
  OPT_v = 1345,                              /* -v */
  OPT_version = 1346,                        /* -version */
  OPT_w = 1347,                              /* -w */
  OPT_wrapper = 1348,                        /* -wrapper */
  OPT_x = 1349,                              /* -x */
  OPT_z = 1350,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

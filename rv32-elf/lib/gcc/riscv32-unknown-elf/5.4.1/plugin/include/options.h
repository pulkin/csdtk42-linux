...
#define MASK_MASK_OPEN_NATIVE (1 << 6)
#define MASK_MASK_NOABS (1 << 7)
#define MASK_MASK_NOADDSUBNORMROUND (1 << 8)
#define MASK_MASK_NOBALL (1 << 9)
#define MASK_MASK_NOBITOP (1 << 10)
#define MASK_MASK_NOCLIP (1 << 11)
#define MASK_MASK_NOFINDUCT (1 << 12)
#define MASK_MASK_NOHWDIV (1 << 13)
#define MASK_MASK_NOHWLOOP (1 << 14)
#define MASK_MASK_NOINDREGREG (1 << 15)
#define MASK_MASK_NOMAC (1 << 16)
#define MASK_MASK_NOMINMAX (1 << 17)
#define MASK_MASK_NOMULMACNORMROUND (1 << 18)
#define MASK_MASK_NOPARTMAC (1 << 19)
#define MASK_MASK_NOPOSTMOD (1 << 20)
#define MASK_MASK_NOSEXT (1 << 21)
#define MASK_MASK_NOSHUFFLEPACK (1 << 22)
#define MASK_MASK_NOSLET (1 << 23)
#define MASK_MASK_NOVECT (1 << 24)
#define MASK_RVC (1 << 25)
#define MASK_MASK_RVSTD (1 << 26)
#define MASK_SAVE_RESTORE (1 << 27)
#define MASK_MASK_SLOOP (1 << 28)
...
#define TARGET_MASK_NOBALL ((target_flags & MASK_MASK_NOBALL) != 0)
#define TARGET_MASK_NOBALL_P(target_flags) ((target_flags & MASK_MASK_NOBALL) != 0)
...
#define TARGET_MASK_NOHWDIV ((target_flags & MASK_MASK_NOHWDIV) != 0)
#define TARGET_MASK_NOHWDIV_P(target_flags) ((target_flags & MASK_MASK_NOHWDIV) != 0)
...
#define TARGET_MASK_RVSTD ((target_flags & MASK_MASK_RVSTD) != 0)
#define TARGET_MASK_RVSTD_P(target_flags) ((target_flags & MASK_MASK_RVSTD) != 0)
...
enum opt_code
{
  ...
  OPT_mnativeomp = 1148,                     /* -mnativeomp */
  OPT_mno_fdiv = 1149,                       /* -mno-fdiv */
  OPT_mnoabs = 1150,                         /* -mnoabs */
  OPT_mnoaddsubnormround = 1151,             /* -mnoaddsubnormround */
  OPT_mnoball = 1152,                        /* -mnoball */
  OPT_mnobitop = 1153,                       /* -mnobitop */
  OPT_mnoclip = 1154,                        /* -mnoclip */
  OPT_mnofinduct = 1155,                     /* -mnofinduct */
  OPT_mnohwdiv = 1156,                       /* -mnohwdiv */
  OPT_mnohwloop = 1157,                      /* -mnohwloop */
  OPT_mnoindregreg = 1158,                   /* -mnoindregreg */
  OPT_mnomac = 1159,                         /* -mnomac */
  OPT_mnominmax = 1160,                      /* -mnominmax */
  OPT_mnomulmacnormround = 1161,             /* -mnomulmacnormround */
  OPT_mnopartmac = 1162,                     /* -mnopartmac */
  OPT_mnopostmod = 1163,                     /* -mnopostmod */
  OPT_mnosext = 1164,                        /* -mnosext */
  OPT_mnoshufflepack = 1165,                 /* -mnoshufflepack */
  OPT_mnoslet = 1166,                        /* -mnoslet */
  OPT_mnovect = 1167,                        /* -mnovect */
  OPT_mplt = 1168,                           /* -mplt */
  OPT_mrvc = 1169,                           /* -mrvc */
  OPT_mrvstd = 1170,                         /* -mrvstd */
  OPT_msave_restore = 1171,                  /* -msave-restore */
  OPT_msloop = 1172,                         /* -msloop */
  OPT_msmall_data_limit_ = 1173,             /* -msmall-data-limit= */
  ...
  OPT_s = 1207,                              /* -s */
  OPT_s_bc_abi = 1208,                       /* -s-bc-abi */
  OPT_save_temps = 1209,                     /* -save-temps */
  OPT_save_temps_ = 1210,                    /* -save-temps= */
  OPT_shared = 1211,                         /* -shared */
  OPT_shared_libgcc = 1212,                  /* -shared-libgcc */
  /* OPT_specs = 1213, */                    /* -specs */
  OPT_specs_ = 1214,                         /* -specs= */
  OPT_static = 1215,                         /* -static */
  OPT_static_libasan = 1216,                 /* -static-libasan */
  OPT_static_libgcc = 1217,                  /* -static-libgcc */
  OPT_static_libgcj = 1218,                  /* -static-libgcj */
  OPT_static_libgfortran = 1219,             /* -static-libgfortran */
  OPT_static_libgo = 1220,                   /* -static-libgo */
  OPT_static_liblsan = 1221,                 /* -static-liblsan */
  OPT_static_libmpx = 1222,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1223,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1231, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1232, */                /* -std=c++1y */
  OPT_std_c__1z = 1233,                      /* -std=c++1z */
  ...
  /* OPT_std_gnu__17 = 1250, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1251, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1252,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1253,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1254,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1255, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1256, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1257,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1258,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1259, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1260, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1261,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1262, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1263, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1264, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1265,                     /* -std=legacy */
  OPT_symbolic = 1266,                       /* -symbolic */
  OPT_t = 1267,                              /* -t */
  OPT_time = 1268,                           /* -time */
  OPT_time_ = 1269,                          /* -time= */
  OPT_traditional = 1270,                    /* -traditional */
  OPT_traditional_cpp = 1271,                /* -traditional-cpp */
  OPT_trigraphs = 1272,                      /* -trigraphs */
  OPT_u = 1273,                              /* -u */
  OPT_undef = 1274,                          /* -undef */
  OPT_v = 1275,                              /* -v */
  OPT_version = 1276,                        /* -version */
  OPT_w = 1277,                              /* -w */
  OPT_wrapper = 1278,                        /* -wrapper */
  OPT_x = 1279,                              /* -x */
  OPT_z = 1280,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

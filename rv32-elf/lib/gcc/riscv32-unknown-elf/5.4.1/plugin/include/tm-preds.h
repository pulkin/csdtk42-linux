/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tvbuildbot/bbworkers/el6132-1/toolchain-el6/build/gcc-git/gcc/config/riscv/riscv.md'.  */
...
extern int fp_unorder_operator (rtx, machine_mode);

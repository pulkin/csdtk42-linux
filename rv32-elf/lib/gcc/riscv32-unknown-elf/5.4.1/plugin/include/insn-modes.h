...
#define HAVE_DFmode
  TFmode,                  /* config/riscv/riscv-modes.def:24 */
#define HAVE_TFmode
...
#define HAVE_TCmode
  V2QImode,                /* config/riscv/riscv-modes.def:29 */
#define HAVE_V2QImode
  V4QImode,                /* config/riscv/riscv-modes.def:27 */
#define HAVE_V4QImode
  V2HImode,                /* config/riscv/riscv-modes.def:27 */

...
# installed.
TK_PREFIX='/home/lee/CSDTK/new_dtk'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/lee/CSDTK/new_dtk'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/lee/cross_csd/insight_cvs/src/build/tk/unix -ltk8.4'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/lee/CSDTK/new_dtk/lib -ltk8.4'
...
# compiled.
TK_SRC_DIR='/home/lee/cross_csd/insight_cvs/src/tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/lee/cross_csd/insight_cvs/src/build/tk/unix -ltkstub8.4'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/lee/CSDTK/new_dtk/lib -ltkstub8.4'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/lee/cross_csd/insight_cvs/src/build/tk/unix/libtkstub8.4.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/lee/CSDTK/new_dtk/lib/libtkstub8.4.a'
